...
<head>
    ...
    <link rel="alternate" type="application/json"
        href="https://demo.theme-sky.com/nooni-fashion/wp-json/wp/v2/pages/9" />
    <link rel="EditURI" type="application/rsd+xml" title="RSD"
        href="https://demo.theme-sky.com/nooni-fashion/xmlrpc.php?rsd" />
    <meta name="generator" content="WordPress 6.4.3" />
    <meta name="generator" content="WooCommerce 8.2.1" />
    <link rel="canonical" href="https://demo.theme-sky.com/nooni-fashion/my-account/" />
    <link rel='shortlink' href='https://demo.theme-sky.com/nooni-fashion/?p=9' />
    <link rel="alternate" type="application/json+oembed"
        href="https://demo.theme-sky.com/nooni-fashion/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fdemo.theme-sky.com%2Fnooni-fashion%2Fmy-account%2F" />
    <link rel="alternate" type="text/xml+oembed"
        href="https://demo.theme-sky.com/nooni-fashion/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fdemo.theme-sky.com%2Fnooni-fashion%2Fmy-account%2F&#038;format=xml" />
...
<body
    class="page-template-default page page-id-9 theme-nooni woocommerce-account woocommerce-page woocommerce-no-js wide header-v4 product-label-rectangle product-hover-vertical-style ts_desktop e-lazyload elementor-default elementor-kit-12">
                            ...
                            <div class="woocommerce">
                                ...
                                <div class="u-columns col2-set" id="customer_login">
                                    ...
                                    <div class="u-column1 col-1">
                                        ...
                                        <form class="woocommerce-form woocommerce-form-login submitForm" action="{{url('user-login')}}" method="post">
                                            <p
                                            ...
                                            <p class="form-row">
                                                ...
                                                <input type="hidden" id="woocommerce-login-nonce"
                                                    name="woocommerce-login-nonce" value="7e23133f45" /><input
                                                    type="hidden" name="_wp_http_referer"
                                                    value="/nooni-fashion/my-account/" /> <button type="submit"
                                    ...
                                    <div class="u-column2 col-2">
                                        ...
                                        <form action="{{url('user-store')}}" method="post"
                                            class="woocommerce-form  register submitForm">
                                            @csrf
                                            ...
                                            <p
                                                ...
                                                <input type="text"
                                                    class="woocommerce-Input woocommerce-Input--text input-text"
                                                    name="fname" id="reg_username" autocomplete="username"
                                                    value="" />
                                            </p>
                                            ...
                                            <p
                                                ...
                                                <input type="password"
                                                    class="woocommerce-Input woocommerce-Input--text input-text"
                                                    name="confirm_password" id="confirm" placeholder="confirm-password" />
                                            </p>
                                            ...
                                            <p class="woocommerce-form-row form-row">
                                                <input type="hidden" id="woocommerce-register-nonce"
                                                    name="woocommerce-register-nonce" value="36a7f0b075" /><input
                                                    type="hidden" name="_wp_http_referer"
                                                    value="/nooni-fashion/my-account/" /> <button type="submit"
    ...
    <link rel='stylesheet' id='redux-custom-fonts-css'
        href='https://nooni-be87.kxcdn.com/nooni-fashion/wp-content/uploads/redux/custom-fonts/fonts.css?ver=1708787250'
        type='text/css' media='all' />
    ...
    <script type="text/javascript" id="elementor-frontend-js-before">
        ...
        var elementorFrontendConfig = {
            ...
            "post": {
                "id": 9,
                "title": "My%20Account%20%E2%80%93%20Nooni",
                "excerpt": "",
                "featuredImage": false
            }
        };
