        ...
        <div class="main-container container-fluid">
            <div class="main-header-left">
                ...
                <div class="hor-logo">
                    <a class="main-logo" href="{{url('/')}}">
                        <img src="{{ asset($settingData->logo ?? null) }}" class="header-brand-img desktop-logo"
                            alt="logo">
                        <img src="{{ asset($settingData->logo ?? null) }}"
            ...
            <div class="main-header-center">
                <div class="responsive-logo">
                    <a href="{{url('/')}}"><img src="{{ asset($settingData->logo ?? null) }}" class="mobile-logo"
                            alt="logo"></a>
                    <a href="{{url('/')}}"><img src="{{ asset($settingData->logo ?? null) }}"
                        ...
                        <div class="main-header-right">
                                ...
                                <div class="dropdown-menu">
                                    <a href="javascript:void(0);" class="dropdown-item d-flex ">
                                        <span class="avatar  me-3 align-self-center bg-transparent"><img
                                                src="{{asset('backend')}}/build/assets/img/flags/french_flag.jpg"
                                                alt="img"></span>
                                        <div class="d-flex">
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item d-flex">
                                        <span class="avatar  me-3 align-self-center bg-transparent"><img
                                                src="{{asset('backend')}}/build/assets/img/flags/germany_flag.jpg"
                                                alt="img"></span>
                                        <div class="d-flex">
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item d-flex">
                                        <span class="avatar me-3 align-self-center bg-transparent"><img
                                                src="{{asset('backend')}}/build/assets/img/flags/italy_flag.jpg" alt="img"></span>
                                        <div class="d-flex">
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item d-flex">
                                        <span class="avatar me-3 align-self-center bg-transparent"><img
                                                src="{{asset('backend')}}/build/assets/img/flags/russia_flag.jpg"
                                                alt="img"></span>
                                        <div class="d-flex">
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item d-flex">
                                        <span class="avatar  me-3 align-self-center bg-transparent"><img
                                                src="{{asset('backend')}}/build/assets/img/flags/spain_flag.jpg" alt="img"></span>
                                        <div class="d-flex">
                                    ...
                                    <div class="main-notification-list">
                                        <div class="media new">
                                            <div class="main-img-user online"><img alt="avatar"
                                                    src="{{asset('backend')}}/build/assets/img/users/5.jpg"></div>
                                        ...
                                        <div class="media">
                                            <div class="main-img-user"><img alt="avatar"
                                                    src="{{asset('backend')}}/build/assets/img/users/2.jpg">
                                            </div>
                                            <div class="media-body">
                                        ...
                                        <div class="media">
                                            <div class="main-img-user online"><img alt="avatar"
                                                    src="{{asset('backend')}}/build/assets/img/users/3.jpg"></div>
                                            <div class="media-body">
                            ...
                            <div class="dropdown main-profile-menu">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item border-top" href="{{url('admin/dashboard')}}">
